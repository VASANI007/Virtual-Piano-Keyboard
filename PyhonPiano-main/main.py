...
pygame.display.set_caption("VASANI007 Piano")
...
def draw_title_bar():
    ...
    img = pygame.transform.scale(pygame.image.load('assets/logo.png'), [100, 100])
    screen.blit(img, (10, -1))
    title_text = font.render('VASANI007 Piano!', True, 'white')
    screen.blit(title_text, (298, 18))
    title_text = font.render('VASANI007 Piano!', True, 'black')
